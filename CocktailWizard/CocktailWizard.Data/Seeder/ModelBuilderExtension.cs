...
namespace CocktailWizard.Data.Seeder
{
    public static class ModelBuilderExtension
    {
        public static void Seeder(this ModelBuilder builder)
        {
            ...
            User adminUser = new User { Id = Guid.Parse("7BD06FE6-79CA-43A1-862B-446A1466BB93"), UserName = "admin", NormalizedUserName = "ADMIN", Email = "admin@cocktailwizard.com", NormalizedEmail = "ADMIN@COCKTAILWIZARD.COM", CreatedOn = DateTime.UtcNow, LockoutEnabled = true, SecurityStamp = "7I5VNHIJTSZNOT3KDWKNFUV5PVYBHGXN" };
